...
var schemaMov = new db.driver().Schema({
    i: 'string',
    recorridoId: {type: Number, index: true},
    desdeBondicom: 'string',
    hastaBondicom: 'string',
    date: Date,
    lat: 'string',
    lon: 'string',
    repetido: {type: Boolean, default: false},
    erroneo: {type: Boolean, default: false},
    desdeOrdenNomb: 'string',
    hastaOrdenNomb: 'string',
    desdeOrdenNombC: 'string',
    hastaOrdenNombC: 'string',
    desdeOrdenC: {type: Number, index: true},
    hastaOrdenC: {type: Number, index: true}
});
